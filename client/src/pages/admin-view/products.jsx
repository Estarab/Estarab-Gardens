...
import { addProductFormElements } from "@/config"; // Updated form controls
import {
  addNewProduct,
  deleteProduct,
  editProduct,
...
const initialFormData = {
  ...
  title: "",
  description: "",
  category: "", // Palm Trees, Fruit Trees, etc.
  characteristics: [], // Multiple characteristics can be selected
  careInstructions: "",
  price: "",
  salePrice: "",
  totalStock: "",
...
function AdminProducts() {
  ...
  function onSubmit(event) {
    ...
    const newProduct = {
      ...formData,
      image: uploadedImageUrl, // Include the image URL
    };
      ...
      <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
        {productList && productList.length > 0
          ? productList.map((productItem) => (
              <AdminProductTile
                key={productItem.id} // Added key for React list rendering
...
//   description: "",
//   category: "",
//   characteristics: "", // Tree, Flower, Shrub, etc.
